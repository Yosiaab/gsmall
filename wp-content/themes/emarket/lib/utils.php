			...
			*/
				...
				if( is_array( $layout_styles ) ){
					foreach ( $layout_styles as $layout_style ){
						if( $layout_style != $home_layout ) :
							if( $layout_style == 'home-style17' ){
							...
							if( $layout_style == 'home-style32' ){
									$output .= '$(document).ready(function() {
											$(".header-bottom-elementor33 .top-left1 .icon-sidebar").on("click", function(e){
				...
				if( $home_layout != '' ){
					...
					if( $home_layout == 'home-style39' ){
						$output .= '$(document).ready(function() {
										...
										$(".header-sibar-home39").toggleClass("open");
										$("body").toggleClass("open");
										e.stopPropagation();
									});
