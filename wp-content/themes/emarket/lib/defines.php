	...
	'fields' => array(
		...
		array(
			...
			'options' => array(
				...
				'home-style17' => esc_html__( 'Layout Games', 'emarket' ),								
				),
			'std' => '',
			'sub_desc' => esc_html__( 'Select style blog', 'emarket' ),
			),
...
$options[] = array(
	...
	'fields' => array(
		...
		array(
			'id' => 'product_layout',
			'type' => 'select',
			'title' => esc_html__('Product Layout', 'emarket'),
			'options' => array(
				'grid' 	=>  esc_html__( 'Grid Layout', 'emarket' ),
		...
		array(
			...
			'type' => 'select',
			'title' => esc_html__('Filter in shop', 'emarket'),
			'options' => array(
			...
			'std' => '',
			'sub_desc' => esc_html__( 'Select style Filter in shop', 'emarket' ),
		),
