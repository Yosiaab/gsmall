			...
			<div class="single-product clearfix">
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<div id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
						<div class="product_detail <?php echo $product_style_variation ? 'variation-select' : ''; ?> <?php echo ( $pd_template_id && $pd_template_id != 'none' ? 'single-design' : ''); ?> row">
							<div class="<?php echo ( sw_woocommerce_vendor_check())?'col-lg-5 col-md-6 col-sm-12 col-xs-12 clear_xs':'col-lg-6 col-md-6 col-sm-12 col-xs-12 clear_xs';?>">							
							...
							<?php if( sw_woocommerce_vendor_check() ) :?>
					...
					<?php if( emarket_options()->getCpanelValue( 'single_sticky' ) == 1 ) : ?>
