...
global $woocommerce; ?>
<div class="top-form top-form-minicart emarket-minicart7 pull-right">
	...
	<div class="wrapp-minicart">
		...
		<div class="cart-checkout">
			...
			<div class="cart-links clearfix">
				...
				<div class="checkout-link"><a href="<?php echo get_permalink(get_option('woocommerce_checkout_page_id')); ?>" title="<?php esc_attr_e( 'Check Out', 'sw_woocommerce' ) ?>"><?php esc_html_e('Check Out', 'sw_woocommerce'); ?></a></div>
			</div>
		</div>
	</div>
</div>
