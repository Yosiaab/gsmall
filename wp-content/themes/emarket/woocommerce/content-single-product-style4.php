				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<div id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
						<div class="product_detail <?php echo $product_style_variation ? 'variation-select' : ''; ?> row">
							<div id="single-left" class="col-lg-9 col-md-12 col-sm-12">
								<div class="wrap-single-product clearfix">
							...
							<div id="single-right" class="col-lg-3 col-md-12 col-sm-12">
								<div class="content_extra_sidebar">
									<!-- woocommerce_extra_sidebar -->
									<?php dynamic_sidebar('extra-product-detail'); ?>
								</div>
							</div>
