...
<div class="top-form top-form-minicart emarket-minicart4 pull-right">
	<div class="top-minicart-icon pull-right">
		<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_attr_e('View your shopping cart', 'emarket'); ?>"><i class="fa fa-shopping-cart"></i><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>';?>
			<div class="cart-total"><?php echo $woocommerce->cart->get_cart_subtotal(); ?></div>
		</a>
	</div>
