...
class WC_POS_Install {
	...
	public static $db_updates = array(
		'3.0.9'    => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-3.0.9.php',
		'3.1.4'    => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-3.1.4.php',
		...
		'3.2.6.4'  => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-3.2.6.4.php',
		...
		'4.2.5.9'  => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-4.2.5.9.php',
		'4.2.6.7'  => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-4.2.6.7.php',
		'4.2.6.8'  => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-4.2.6.8.php',
		'4.2.8'    => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-4.2.8.php',
		'4.2.8.5'  => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-4.2.8.5.php',
		'4.2.9'    => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-4.2.9.php',
		'4.3.1'    => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-4.3.1.php',
		'4.3.6'    => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-4.3.6.php',
		'4.4'      => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-4.4.php',
		'4.4.5'    => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-4.4.5.php',
		'4.4.6'    => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-4.4.6.php',
		'4.4.7'    => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-4.4.7.php',
		'4.5.9'    => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-4.5.9.php',
	...
	public static function check_version() {
		if ( ! defined( 'IFRAME_REQUEST' ) && WC_POS_VERSION !== get_option( 'wc_pos_db_version' ) ) {
	...
	public static function install_actions() {
		if ( ! empty( $_GET['do_update_wc_pos'] ) ) {
			...
			wp_redirect( admin_url( 'admin.php?page=wc-pos-settings' ) );
			exit;
		}
	}
	...
	public static function install() {
		...
		if ( is_null( $current_version ) && apply_filters( 'wc_pos_enable_setup_wizard', true ) ) {
			...
			foreach ( $admins as $admin ) {
				update_user_meta( $admin->ID, 'manageedit-productcolumnshidden', array( 'wc_pos_product_grid' ) );
			}
		}
	...
	public static function create_default_posts() {
		...
		if ( ! get_option( 'wc_pos_default_outlet', false ) ) {
			...
			if ( $post_id ) {
				...
				if ( empty( get_user_meta( get_current_user_id(), 'outlet', true ) ) ) {
					update_user_meta( get_current_user_id(), 'outlet', array( (string) $post_id ) );
				}
			}
		}
