...
<html>
	<head>
		...
		<link rel="manifest" href="<?php echo esc_url( WC_POS()->plugin_url() ) . '/assets/dist/images/manifest.json'; ?>">
		...
		<link rel="mask-icon" href="<?php echo esc_url( WC_POS()->plugin_url() ) . '/assets/dist/images/safari-pinned-tab.svg'; ?>" color="#96588a">
