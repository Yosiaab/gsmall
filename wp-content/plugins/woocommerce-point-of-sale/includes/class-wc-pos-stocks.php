	...
	public function display_single_stocks_page() {
				...
				<div class="wp-filter">
					<div class="filter-items">
						<form action="" method="post" id="put_wc_pos_barcode">
							<label for="woocommerce_default_country"><?php esc_html_e( 'SKU', 'woocommerce-point-of-sale' ); ?></label>
						...
						<tbody>
							<tr id="" class="iedit author-self level-0 post-99 type-product status-publish has-post-thumbnail hentry product_cat-music product_cat-singles">
								...
								<td class="price column-price" data-colname="Increase">
									...
									<input type="submit" value="Replace" class="page-title-action" id="replace_stock">
								</td>
							</tr>
						</tbody>
					</table>
		...
		<script>
			jQuery(document).ready(function($){
				...
				$("#increase_stock, #replace_stock").on('click', function(e) {
					e.preventDefault();
					var id = $('#product_id').val();
					var operation = $(this).is('#increase_stock') ? 'increase' : 'replace';
