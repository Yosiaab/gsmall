 ...
 * End of Day Report
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/plain/pos-end-of-day-report.php.
 *
...
<table class="td" cellspacing="0" cellpadding="6" style="margin-bottom: 40px; width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
	<thead>
		...
		<tr>
			...
			<td class="td" style="text-align:<?php echo esc_attr( $text_align ); ?>; vertical-align:middle; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;"><?php echo esc_html( date_i18n( 'Y-m-d H:i', $details['date_opened'] ) ); ?></td>
		</tr>
		<tr>
			<th class="td" scope="row" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Closed', 'woocommerce-point-of-sale' ); ?></th>
			<td class="td" style="text-align:<?php echo esc_attr( $text_align ); ?>; vertical-align:middle; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;"><?php echo esc_html( date_i18n( 'Y-m-d H:i', $details['date_closed'] ) ); ?></td>
		</tr>
...
<table class="td" cellspacing="0" cellpadding="6" style="margin-bottom: 40px; width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
	...
	<tbody>
		...
		foreach ( $details['payments'] as $key => $payment ) :
			...
			$difference = $counted ? $counted - $payment['total'] : 0;
			?>
			<tr>
