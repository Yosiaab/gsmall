...
?>
<div id="<?php echo 'slider_' . $widget_id; ?>" class="responsive-slider sw-category-slider14 loading <?php echo isset( $style ) ? esc_attr( $style ) : '';?>"  data-append=".resp-slider-container" data-lg="<?php echo esc_attr( $columns ); ?>" data-md="<?php echo esc_attr( $columns1 ); ?>" data-sm="<?php echo esc_attr( $columns2 ); ?>" data-xs="<?php echo esc_attr( $columns3 ); ?>" data-mobile="<?php echo esc_attr( $columns4 ); ?>" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>"  data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
	<?php if( $title1 != '' ){ ?>
	<div class="box-title">
			...
			<div class="item item-product-cat">
				<div class="item-wrap">
					...
					<div class="item-content">
						...
						<div class="product-count"><?php echo $term->count; ?><?php echo esc_html__(' items ','sw-woocomerce'); ?></div>
					</div>
				</div>
			</div>
			<?php endif; ?>
