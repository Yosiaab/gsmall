...
?>
<div class="bundle-slider-style5" id="<?php echo $category.'_'.$id; ?>" >
					...
					<div class="item-content-left clearfix">
						...
						<div class="product-info">
							...
							<div class="emarket-stock clearfix">
								<div class="stock-sold"><?php esc_html_e( 'Sold number: ', 'sw_product_bundles' ) ?><span><?php echo $total_sales; ?></span></div>
							</div>
							<?php } ?>
						...
						<div id="<?php echo esc_attr( 'tab_cat_'.$ids.'_' .$widget_id ); ?>" class="woo-tab-container-slider clearfix">
							<div class="resp-slider-container">
									...
									<div class="item-bottom clearfix">
										...
										<div class="wrap-price pull-left">
										
											<div class="item">
												<span class="title"><?php echo esc_html__( 'Original price', 'sw_product_bundles' ); ?></span>
											...
											<?php if ( $sale_price ): ?>
											<div class="item">
												<span class="title"><?php echo esc_html__( 'Save', 'sw_product_bundles' ); ?></span>
												<span class="price save"><?php echo get_woocommerce_currency_symbol(); ?><?php echo sprintf( '%01.2f', $save_price); ?></span>
											</div>
											<?php endif; ?>
											
											<?php if ( $sale_price ): ?>
											<div class="item">
												<span class="title"><?php echo esc_html__( 'Combo price', 'sw_product_bundles' ); ?></span>
										...
										<?php } ?>
										<h4 class="pull-right"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute();?>"><?php echo esc_html__('Get this Combo','sw_product_bundles'); ?></a></h4>								
									</div>
							</div>
						</div>
					</div>
