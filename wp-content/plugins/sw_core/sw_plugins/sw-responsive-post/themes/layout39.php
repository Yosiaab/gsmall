									...
									<div class="item-detail">
										...
										<div class="entry-content">
											<div class="entry-meta clearfix">
												<span class="entry-date"><i class="fa fa-clock-o"></i><?php echo get_the_date('j M Y');?></span>
												<span class="entry-author"><i class="fa fa-user"></i><?php esc_html_e('by', 'sw_core'); ?> <?php the_author_posts_link(); ?></span>
											</div>
