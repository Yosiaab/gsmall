...
class WC_POS_Paymentsense {
	...
	public static function params( $params ) {
		...
		$params['paymentsense_host_address']      = $paymentsense_data['host_address'] ? set_url_scheme( esc_url( $paymentsense_data['host_address'] ), 'https' ) : '';
		$params['paymentsense_api_key']           = $paymentsense_data['api_key'] ? $paymentsense_data['api_key'] : '';
		$params['paymentsense_installer_id']      = $paymentsense_data['installer_id'] ? $paymentsense_data['installer_id'] : '';
		$params['paymentsense_software_house_id'] = $paymentsense_data['software_house_id'] ? $paymentsense_data['software_house_id'] : '';
	...
	public static function register_options_tabs( $tabs ) {
		...
		if ( 'yes' === $paymentsense_data['enabled'] ) {
			$tabs['paymentsense'] = array(
