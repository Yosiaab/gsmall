...
class WC_POS_Gateway_BACS extends WC_Payment_Gateway {
	...
	public function params( $params ) {
		...
		$params['bacs_instructions'] = $settings['instructions'];
	...
	public function process_payment( $order_id ) {
		...
		if ( $order->get_total() > 0 ) {
			...
			$order->update_status( apply_filters( 'woocommerce_pos_bacs_process_payment_order_status', 'on-hold', $order ), __( 'Awaiting BACS payment', 'woocommerce-point-of-sale' ) );
		} else {
