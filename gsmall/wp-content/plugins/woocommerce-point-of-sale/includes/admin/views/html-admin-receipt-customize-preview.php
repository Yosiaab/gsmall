...
$address          = WC()->countries->get_formatted_address(
	array(
		...
		'state'     => $default_outlet->get_state(),
...
<div id="receipt-preview">
	...
	<div id="receipt-order-barcode">
		<img src="<?php echo esc_url( WC_POS()->plugin_url() . '/includes/vendor/barcode/image.php?filetype=PNG&dpi=72&scale=2&rotation=0&font_family=0&font_size=12&thickness=30&start=NULL&code=BCGcode128&text=WC1234AE' ); ?>">
	</div>
