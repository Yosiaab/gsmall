...
$date_formats   = array_unique( apply_filters( 'wc_pos_receipt_order_date_formats', array( 'F j, Y', 'Y-m-d', 'm/d/Y', 'd/m/Y' ) ) );
$date_formats[] = '';
$time_formats   = array_unique( apply_filters( 'wc_pos_receipt_order_time_formats', array( 'g:i a', 'g:i A', 'H:i' ) ) );
$time_formats[] = '';
