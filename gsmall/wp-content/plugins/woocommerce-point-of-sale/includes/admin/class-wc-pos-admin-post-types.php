...
class WC_POS_Admin_Post_Types {
	...
	public function __construct() {
		include_once dirname( __FILE__ ) . '/class-wc-pos-admin-meta-boxes.php';
	...
	public function pos_receipt() {
		...
		include_once WC_POS_ABSPATH . '/includes/admin/views/html-admin-receipt-customize.php';
	...
	public function delete_post( $post_id ) {
		...
		if ( 'pos_register' === get_post_type( $post_id ) ) {
			...
			$wpdb->query(
				...
				SET pm.meta_value = %d
				WHERE pm.meta_key = 'wc_pos_id_register' AND pm.meta_value = %d
				",
