...
class WC_POS_Register extends WC_Data {
	...
	public function __construct( $data = '' ) {
		...
		// This filter allows custom register objects to be created on the fly.
	 ...
	 * @return int Post ID.
	 */
	public function get_temp_order( $context = 'view' ) {
		return $this->get_prop( 'temp_order', $context );
	}
	 ...
	 * @param int $id Post ID.
	 */
	public function set_temp_order( $id ) {
		$this->set_prop( 'temp_order', $id );
	}
