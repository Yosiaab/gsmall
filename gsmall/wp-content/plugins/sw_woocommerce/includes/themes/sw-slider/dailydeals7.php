		...
		<div class="resp-slider-container">
			<div class="box-slider-top">
				...
				<div class="block-title clearfix">
					...
					<div class="description custom-font"><?php echo ( $description != '' ) ? $description : ''; ?></div>
				</div>
				<?php } ?>
