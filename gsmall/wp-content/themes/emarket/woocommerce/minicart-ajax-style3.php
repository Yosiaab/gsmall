...
<div class="top-form top-form-minicart emarket-minicart3 pull-right">
	<div class="top-minicart-icon pull-right">
		<div class="title-cart">
			<h3><?php esc_html_e('My Cart', 'emarket'); ?><?php echo '<span class="minicart-numbers">'.$woocommerce->cart->cart_contents_count.'</span>';?> </h3>
			<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_html_e('View your shopping cart', 'emarket'); ?>">
			<?php echo $woocommerce->cart->get_cart_subtotal(); ?></a>
		</div>
	</div>
