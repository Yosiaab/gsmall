...
function emarket_body_class($classes) {
	...
	$sticky_single_product 		= emarket_options()->getCpanelValue( 'sticky_single_product' );
	//$single_sticky_bottom 		= emarket_options()->getCpanelValue( 'single_sticky_bottom' );
	...
	if(class_exists('jet-smart-filters-pagination')){
		$classes[] = 'remove-pagination';
	}
	...
	if( $sticky_single_product == '' ){
		$classes[] = 'disable-sticky-single';
		//$classes[] = 'single-sticky';
	}
	
	 if( $sticky_single_product == 'bottom' ){
	...
	if( $emarket_blog_style == 'home-style17' && !is_front_page() ){
	...
	if( class_exists( 'WooCommerce' ) ){
		if( ( is_shop() && ( $product_filter_style == 'drawer' ) && emarket_options() -> getCpanelValue('sidebar_product') == 'left' ) || ( is_product_category() && ( $product_filter_style == 'drawer' ) && emarket_options() -> getCpanelValue('sidebar_product') == 'left' ) ){
			$classes[] = 'page-filter-drawer';
		}
	}
	
	if( class_exists( 'WooCommerce' ) ){
		if( ( is_shop() && $product_filter_style == 'canvas' ) || ( is_product_category() && $product_filter_style == 'canvas' ) ){
			$classes[] = 'page-shop-filter-canvas';
		}
	}
	if( class_exists( 'WooCommerce' ) ){
		if( ( is_shop() && emarket_options()->getCpanelValue( 'mobile_addcart' ) && emarket_mobile_check() ) || ( is_product_category() && emarket_options()->getCpanelValue( 'mobile_addcart' ) && emarket_mobile_check() ) ){
			$classes[] = 'show-cart-mobile';
		}
	}
