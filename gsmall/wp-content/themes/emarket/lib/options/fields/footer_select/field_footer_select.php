<?php
class Emarket_Options_footer_select extends Emarket_Options{	
	...
	*/
	function render(){
		...
		echo '<option value="" selected>'.esc_html__( 'Select Footer', 'sw_core' ).'</option>';
